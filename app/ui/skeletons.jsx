  ...
  return (
    <div className={`${shimmer} relative w-full overflow-hidden md:col-span-4`}>
      ...
      <div className="rounded-xl bg-gray-100 p-4">
        <div className="mt-0 grid h-[410px] grid-cols-12 items-end gap-2 rounded-md bg-white p-4 sm:grid-cols-8 md:gap-4" />
...
export function TableEntriesMobileSkeleton() {
  return (
